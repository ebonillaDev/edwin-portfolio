export const DATA = {
  ...
  experience: [
    {
      ...
      logo: '<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Chase</title><path d="M0 15.415c0 .468.38.85.848.85h5.937V.575L0 7.72v7.695m15.416 8.582c.467 0 .846-.38.846-.849v-5.937H.573l7.146 6.785h7.697M24 8.587a.844.844 0 0 0-.847-.846h-5.938V23.43l6.782-7.148L24 8.586M8.585.003a.847.847 0 0 0-.847.847v5.94h15.688L16.282.003H8.585Z"/></svg>'
    },
    {
  ...
  education: {
    ...
    logo: `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path d="M12 3L1 9l11 6 9-4.91V17h2V9L12 3zM3.85 12.06l-.1.05V15c0 1.66 3.71 3 8.25 3s8.25-1.34 8.25-3v-2.89l-1.65.9c-.1.05-.18.11-.27.16-.93.5-2.07.83-3.33 1.05-1 .18-2.01.28-3 .28s-2-.1-3-.28c-1.26-.22-2.4-.55-3.33-1.05-.09-.05-.17-.11-.27-.16z"/></svg>`
  }
};